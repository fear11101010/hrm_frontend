...
export const ADMIN_MENU_ENTRY_EDIT_PAGE =(id,mappingId)=> mappingId?`/lunch-management/menu-entry/${id}/${mappingId}/edit`:`/lunch-management/menu-entry/${id}/edit`;
export const ADMIN_MENU_ENTRY_EDIT_PAGE_URL =`/lunch-management/menu-entry/:id/:mappingId?/edit`;
