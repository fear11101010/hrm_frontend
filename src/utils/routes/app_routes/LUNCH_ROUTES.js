...
export const ADMIN_MENU_ENTRY_EDIT_PAGE = (id, mappingId) =>
  mappingId ? `/lunch-management/menu-entry/${id}/edit/${mappingId}` : `/lunch-management/menu-entry/${id}/edit`;
...
export const SUBSIDY_COST_UPDATE_URL = "/lunch-management/sub-sidy-cost/update/:id";
export const SUBSIDY_COST_UPDATE = (id) => `/lunch-management/sub-sidy-cost/update/${id}`;
