...
import {TICKET_LIST_CREATE_API, TICKET_LIST_OTHER_API} from "../../../utils/routes/api_routes/SP_API_ROUTES";
...
function OtherTickets(props) {
    ...
    const {data,isLoading} = useFetch(TICKET_LIST_OTHER_API(page,limit),refreshData);
        ...
        <>
            <Layout>
                ...
                <Container fluid>
                    <Card>
                        <Card.Body>
                            <CustomTable data={data.data} total={data.count} pagination={{show:true,perPageList:[10,20,30,50,100],onPageOrLimitChange}} columns={OTHER_TICKET_TABLE_COLUMNS(handleShow)} size={"sm"} responsive/>
                        </Card.Body>
                    </Card>
                </Container>
