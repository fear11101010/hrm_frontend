                ...
                <div className="list-group list-group-flush my-n3">
                    ...
                    <div className="row align-items-center">
                      <div className="col-auto">
                        <a href="project-overview.html" className="avatar avatar-4by3">
                          <img src="/img/avatars/projects/project-1.jpg" alt="..." className="avatar-img rounded" />
                        </a>
                      </div>
                  ...
                  <div className="list-group-item">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        <a href="project-overview.html" className="avatar avatar-4by3">
                          <img src="/img/avatars/projects/project-2.jpg" alt="..." className="avatar-img rounded" />
                        </a>
                      </div>
                      <div className="col ms-n2">
                        <h4 className="mb-1">
                  ...
                  <div className="list-group-item">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        <a href="project-overview.html" className="avatar avatar-4by3">
                          <img src="/img/avatars/projects/project-3.jpg" alt="..." className="avatar-img rounded" />
                        </a>
                      </div>
                      <div className="col ms-n2">
                        <h4 className="mb-1">
                  ...
                  <div className="list-group-item">
                    <div className="row align-items-center">
                      <div className="col-auto">
                        <a href="project-overview.html" className="avatar avatar-4by3">
                          <img src="/img/avatars/projects/project-5.jpg" alt="..." className="avatar-img rounded" />
                        </a>
                      </div>
                      <div className="col ms-n2">
                        <h4 className="mb-1">
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        <div className="avatar-group">
                          <a href="#" className="avatar avatar-xs" data-bs-toggle="tooltip" title="Dianna Smiley">
                            <img src="/img/avatars/profiles/avatar-1.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                          <a
                            ...
                            title="Ab Hadley"
                          >
                            <img src="/img/avatars/profiles/avatar-2.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                          <a
                            href="profile-posts.html"
                            className="avatar avatar-xs"
                            ...
                            title="Adolfo Hess"
                          >
                            <img src="/img/avatars/profiles/avatar-3.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                          <a
                            href="profile-posts.html"
                            className="avatar avatar-xs"
                          ...
                          >
                            <img src="/img/avatars/profiles/avatar-4.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                        </div>
                      </td>
                      <td className="text-end">
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        <div className="avatar-group justify-content-end">
                          ...
                          <a href="#!" className="avatar avatar-xs" data-bs-toggle="tooltip" title="Ab Hadley">
                            <img src="/img/avatars/profiles/avatar-2.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                          <a href="#!" className="avatar avatar-xs" data-bs-toggle="tooltip" title="Adolfo Hess">
                            <img src="/img/avatars/profiles/avatar-3.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                        </div>
                      </td>
                    ...
                    <tr>
                      ...
                      <td className="text-end">
                        <div className="avatar-group justify-content-end">
                          ...
                          <a href="#!" className="avatar avatar-xs" data-bs-toggle="tooltip" title="Daniela Dewitt">
                            <img src="/img/avatars/profiles/avatar-4.jpg" className="avatar-img rounded-circle" alt="..." />
                          </a>
                        </div>
                      </td>
                ...
                <div className="list-group list-group-flush list-group-activity my-n3">
                    ...
                    <div className="row">
                      <div className="col-auto">
                        <div className="avatar avatar-sm avatar-online">
                          <img className="avatar-img rounded-circle" src="/img/avatars/profiles/avatar-1.jpg" alt="..." />
                        </div>
                      </div>
                      <div className="col ms-n2">
                        <h5 className="mb-1">Dianna Smiley</h5>

                        <p className="small text-gray-700 mb-0">Uploaded the files "Launchday Logo" and "New Design".</p>
                  ...
                  <div className="list-group-item">
                    <div className="row">
                      <div className="col-auto">
                        <div className="avatar avatar-sm avatar-online">
                          <img className="avatar-img rounded-circle" src="/img/avatars/profiles/avatar-2.jpg" alt="..." />
                        </div>
                      </div>
                      <div className="col ms-n2">
                        <h5 className="mb-1">Ab Hadley</h5>

                        <p className="small text-gray-700 mb-0">Shared the "Why Dashkit?" post with 124 subscribers.</p>
                    ...
                    <div className="row">
                      <div className="col-auto">
                        <div className="avatar avatar-sm avatar-offline">
                          <img className="avatar-img rounded-circle" src="/img/avatars/profiles/avatar-3.jpg" alt="..." />
                        </div>
                      </div>
                      <div className="col ms-n2">
                        <h5 className="mb-1">Adolfo Hess</h5>

                        <p className="small text-gray-700 mb-0">Exported sales data from Launchday's subscriber data.</p>
          ...
          <div className="col-12 col-xl-7">
            <div className="card">
              <div className="card-header">
                ...
                <span className="badge bg-secondary-soft">23 Archived</span>
              </div>
              <div className="card-body">
                {/*Checklist*/}
                <div className="checklist">
                  <div className="form-check">
                    ...
                    <label className="form-check-label">Delete the old mess in functions files.</label>
                  </div>
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="checklistTwo" />
                    <label className="form-check-label">Refactor the core social sharing modules.</label>
                  </div>
                  <div className="form-check">
                  ...
                  <div className="form-check">
                    ...
                    <label className="form-check-label">Share the documentation for the new unified API.</label>
                  </div>
                  <div className="form-check">
                    <input className="form-check-input" type="checkbox" id="checklistSix" checked />
                    <label className="form-check-label">
