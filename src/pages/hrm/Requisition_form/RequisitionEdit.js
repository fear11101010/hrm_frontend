...
import {
  GET_SBU_API,
  RESOURCE_REQUISITION_DETAILS,
  RESOURCE_REQUISITION_EDIT,
...
export default function RequisitionEdit() {
  ...
  const finalsubmit = (e) => {
    ...
    API.post(RESOURCE_REQUISITION_EDIT + `${id}`, submit_data)
      .then((res) => {
  ...
  return (
    <Layout>
      <PageHeader subTitle={""} title={"Requisition Details"} onBack />
      {showLoading && <Loader />}
          ...
          <Card.Body>
            ...
            <Row>
              <Col xs={12} sm={12} md={4}>
                ...
                <input
                  type="number"
                  placeholder={data?.quantity_requisition}
              ...
              <Col xs={12} sm={12} md={4}>
                ...
                <select className="form-control select2" onChange={(e) => setreason_recruitment(e.target.value)}>
                  <option value="New Recruit" selected={data?.reason_for_recruitment === "New Recruit" ? true : false}>
                    New Recruit
                  </option>
                  <option value="Replacement" selected={data?.reason_for_recruitment === "Replacement" ? true : false}>
                    Replacement
                  </option>
                  <option value="R & D" selected={data?.reason_for_recruitment === "R & D" ? true : false}>
                    R & D
                  </option>
                </select>
              </Col>
            ...
            <Row>
              <Col xs={12} sm={12} md={4}>
                ...
                <input
                  type="number"
                  placeholder={data?.number_of_resource}
                  onChange={(evnt) => setnumber_of_resource(evnt.target.value)}
                  className="form-control"
                />
              </Col>
              <Col xs={12} sm={12} md={4}>
              ...
              <Col xs={12} sm={12} md={4}>
                ...
                <input
                  type="text"
                  placeholder={data?.source_of_fund}
                      ...
                      return (
                        <tr key={index}>
                          <td>
                            <input
                              type="text"
                              placeholder={data.project_invoice_amount}
                          ...
                          <td>
                            <input
                              type="text"
                              placeholder={data.resources_involved}
                              onChange={(evnt) => handleChange(index, evnt)}
                          ...
                          <td>
                            <input
                              type="text"
                              placeholder={data.total_resource_cost}
                              onChange={(evnt) => handleChange(index, evnt)}
                          ...
                          <td>
                            <input
                              type="text"
                              placeholder={data.project_duration}
                              onChange={(evnt) => handleChange(index, evnt)}
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>
                        <textarea
                          className="form-control"
                          placeholder={data.required_skills}
                    ...
                    {rowsData1.map((data, index) => {
                      return (
                        <tr key={index}>
                          ...
                          <td>
                            <Select
                              options={employeelist?.map((d) => ({
                                label: d.name,
                                value: d.id,
                                designation: d.designation,
                                ds_id: d.employee_id,
                                sbu: d.sbu.name,
                                sub_sbu: d.sbu_director_id.name,
                              }))}
                              onChange={(e) => {
                          ...
                          <td>
                            {Number.isInteger(data.employee_name) ? data.sbu_project : data.employee_name.sub_sbu.name}
                          </td>
                          <td>
                            <input
                              type="text"
                              placeholder={data.allocated_hour}
                              onChange={(evnt) => handleChange2(index, "allocated_hour", evnt.target.value)}
                              name="allocated_hour"
                              className="form-control"
                            />
                          </td>
                          <td>
                            <input
                              type="text"
                              placeholder={data.skill}
                              onChange={(evnt) => handleChange2(index, "skill", evnt.target.value)}
                              name="skill"
                              className="form-control"
                            />
                          </td>
                          <td>
                            <input
                              type="text"
                              placeholder={data.project_revenue}
                              onChange={(evnt) => handleChange2(index, "project_revenue", evnt.target.value)}
