...
export default function RequisitionForm() {
    ...
    const finalsubmit = (e) => {
        ...
        API.post(RESOURCE_REQUISITION_FORM, submit_data).then(res => {
                            ...
                            <div className="stepwizard">
                                <div className="stepwizard-row setup-panel">
                                    <div className="stepwizard-step col-xs-3">
                                        <a type="button" onClick={() => setStepwizard(1)} className={stepwizard === 1 ? "btn btn-info btn-circle" : "btn btn-default btn-circle"}
                                        >1</a>
                                        <p><small>Approval</small></p>
                                    </div>
                                    <div className="stepwizard-step col-xs-3">
                                        <a type="button" onClick={() => setStepwizard(2)} className={stepwizard === 2 ? "btn btn-info btn-circle" : "btn btn-default btn-circle"}
                                        >2</a>
                                        <p><small>Reason for Recruitment</small></p>
                                    </div>
                                    <div className="stepwizard-step col-xs-3">
                                        <a type="button" onClick={() => setStepwizard(3)} className={stepwizard === 3 ? "btn btn-info btn-circle" : "btn btn-default btn-circle"}
                                        >3</a>
                                        <p><small>Reason for Recruitment</small></p>
                                    </div>
                                    <div className="stepwizard-step col-xs-3">
                                        <a type="button" onClick={() => setStepwizard(4)} className={stepwizard === 4 ? "btn btn-info btn-circle" : "btn btn-default btn-circle"}
                                        >4</a>
                                        <p><small>Skills and Experience</small></p>
                                    </div>
                                    <div className="stepwizard-step col-xs-3">
                                        <a type="button" onClick={() => setStepwizard(5)} className={stepwizard === 5 ? "btn btn-info btn-circle" : "btn btn-default btn-circle"}
                                        >5</a>
                                        <p><small>Current Skill Matrix </small></p>
                                    </div>
                                </div>
                            </div>
                            {stepwizard === 1 && <div className="row">
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        <input type="number" value={quantity_recruitment} onChange={(evnt) => setquantity_recruitment(evnt.target.value)} className="form-control" />
                                    </div>
                                </div>
                                <button className="btn btn-primary nextBtn pull-right mt-4" onClick={() => setStepwizard(stepwizard + 1)} type="button">Next
                                </button>
                            </div>}
                            {stepwizard === 2 && <div className="row">
                                <div className="col-md-6">
                                    <div className="form-group">
                                ...
                                <div className="col-md-6">
                                    <div className="form-group">
                                        ...
                                        <input type="number" onChange={(e)=> setnumber_of_resource(e.target.value)} className="form-control" />
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    <div className="form-group">
                                ...
                                <div className="row">
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-md-6 border">
                                            <div className='form-group'>
                                                Are mentioned skillset resources available in a non-revenue earning
                                                Project? If yes, please mention it.
                                                <br />
                                                <br />
                                                Are mentioned skillset resources in sister concern? If yes, please
                                                mention it.
                                            </div>
                                        </div>
                                        <div className="col-md-6 border">
                                            <div className='form-group'>
                                                Are mentioned skillset resources available in another SBU/Sub SBU?
                                ...
                                <div className="row">
                                    <div className="form-group">
                                        <div className="form-check">
                                            <input className="form-check-input" type="radio" onChange={(e) => setskill_experience(true)}
                                                name="exampleRadios" id="exampleRadios7" checked={skill_experience ? true : false} />
                                        ...
                                        <br />
                                        <div className="form-check">
                                            <input className="form-check-input" type="radio" onChange={(e) => setskill_experience(false)}
                                                name="exampleRadios" id="exampleRadios8" checked={skill_experience ? false : true} />
                                            <label className="form-check-label" for="exampleRadios8">No (if yes
                                        ...
                                        <div className="table-responsive">
                                            <table className="table table-bordered table-md">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td><textarea onChange={(e) => setmin_skill(e.target.value)} className="form-control"></textarea></td>
                                                        <td><textarea onChange={(e) => setrequired_skills(e.target.value)} className="form-control"></textarea></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                    ...
                                    <div className="row ">
                                        <div className='form-group'>
                                            <p className="text-danger"> Note: Above this part Need to Fill-up by
                                                Requisition request by, Verified by HR and Finance.</p>
                                        </div>
                                    </div>
                                    <button className="btn btn-primary nextBtn pull-right mt-4" onClick={() => setStepwizard(stepwizard + 1)} type="button">Next
                                    </button>
                            ...
                            {stepwizard === 5 &&
                                <div className="row">
                                            ...
                                            <table className="table">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><button className="btn btn-outline-success" onClick={addTableRows1} >+</button></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    <TableRows1 employee_data={employeelist} rowsData={rowsData1} deleteTableRows={deleteTableRows1} handleChange={handleChange1} handleChange2={handleChange2} />
                                                </tbody>
                                            </table>
                                    ...
                                    <div className="row ">
                                        <div className='form-group'>
                                            <p className="text-danger"> Note: Above this part Need to Fill-up by
                                                Requisition request by, Verified by HR</p>
                                        </div>
                                    </div>

                                    <button class="btn btn-success pull-right" onClick={finalsubmit} type="submit">Save</button>
