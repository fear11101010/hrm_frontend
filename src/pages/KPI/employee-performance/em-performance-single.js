...
import { EMPLOYEE_PERFORMANCE_INDEX_PAGE, EMPLOYEE_PERFORMANCE_PAGE } from "../../../utils/APP_ROUTES";
                ...
                <Col xs={12} sm={12} md={6} className="d-flex flex-column">
                  <Form.Group>
                    <Form.Label htmlFor="COURAGEOUS">
                      ...
                      <h5 className="mb-0 text-secondary">Moral Strength: faith and belief in oneself, self confidence:</h5>
                    </Form.Label>
                    <Form.Control
                      as={"textarea"}
