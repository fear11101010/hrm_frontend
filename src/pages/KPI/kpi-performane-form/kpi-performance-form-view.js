...
export default function KpiPerformanceFormView() {
    ...
    return (
        <Layout>
            <div>
                <PageHeader subTitle={""} title={"KPI Performance Form Details"}/>
                <Container fluid>
                    <Card>
                        <Card.Body>
                            <Row>
                                ...
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header as={"div"}  >
                                        <div>
                                            ...
                                            <h6 className="header-pretitle mb-0">(Moral Strength: faith and
                                                belief
                                                in oneself,
                                                self confidence)</h6>
                                        </div>
                                    ...
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                ...
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.courageous || 'N\\A'}</p>
                                            </Col>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Rating</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{findValueElem(data?.courageous_rating) || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="1">
                                    <Accordion.Header as={"div"}  >
                                        <div>
                                            ...
                                            <h6 className="header-pretitle mb-0">(Team player, not exclusive:
                                                Enjoy
                                                sharing and
                                                collaborating with relevent parties)</h6>
                                        </div>
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Value</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.teamwork || 'N\\A'}</p>
                                            </Col>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Rating</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{findValueElem(data?.teamwork_rating) || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="2">
                                    <Accordion.Header as={"div"}  >
                                        <div>
                                            ...
                                            <h6 className="header-pretitle mb-0">(Attentive, Interactive :
                                                consider everyone
                                                inside & outside as customer ; stakeholder)</h6>
                                        </div>
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Value</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.responsive || 'N\\A'}</p>
                                            </Col>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Rating</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{findValueElem(data?.responsive_rating) || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="3">
                                    <Accordion.Header as={"div"}  >
                                        <div>
                                            ...
                                            <h6 className="header-pretitle mb-0">(Business minds: Translates
                                                imagination into
                                                business)</h6>
                                        </div>
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Value</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.creative || 'N\\A'}</p>
                                            </Col>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Rating</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{findValueElem(data?.creative_rating) || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="4">
                                    <Accordion.Header as={"div"}  >
                                        <div>
                                            ...
                                            <h6 className="header-pretitle mb-0">(Deserving of trust ,
                                                confidence , reliable, dependable)</h6>
                                        </div>
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Value</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.trustworthy || 'N\\A'}</p>
                                            </Col>
                                            <Col sm={12} xs={12} md={12}>
                                                <h6 className="header-pretitle mb-2">Rating</h6>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{findValueElem(data?.trustworthy_rating) || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                            ...
                            <Accordion>
                                <Accordion.Item eventKey="0">
                                    ...
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.other_sustainable_achievement || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="1">
                                    ...
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.significant_issue || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                            ...
                            <Accordion>
                                <Accordion.Item eventKey="0">
                                    ...
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.individual_comment || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="1">
                                    ...
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.manager_comment || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="2">
                                    ...
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.senior_manager_functional_head_comment || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                                <Accordion.Item eventKey="3">
                                    <Accordion.Header as={"div"}  >
                                        <div>
                                            <h3 className="header-title mb-0">DIRECTOR AND CHIEF OPERATING OFFICER'S
                                                COMMENTS</h3>
                                        </div>
                                    </Accordion.Header>
                                    <Accordion.Body>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.director_chief_operating_officer_comment || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
                    ...
                    <Card>
                        <Card.Body>
                            <h2 className="header-title mb-0">OVERALL PERFORMANCE BASED ON ALL OF THE ABOVE
                                RATING</h2>
                            <hr className="mb-4"/>
                            <Accordion>
                                <Accordion.Item>
                                    <Accordion.Body className={"show"}>
                                        <Row>
                                            <Col sm={12} xs={12} md={12}>
                                                <p className="fs-5 fw-bold" contentEditable={false} >{data?.overall_performance || 'N\\A'}</p>
                                            </Col>
                                        </Row>
                                    </Accordion.Body>
                                </Accordion.Item>
